...
@Slf4j
public class MultipleChoiceQuestionTestServiceImpl implements MultipleChoiceQuestionTestService{
    private MultipleChoiceQuestionTestRepository multipleChoiceQuestionTestRepository;
    private SubCategoryRepository subCategoryRepository;

    public MultipleChoiceQuestionTestServiceImpl(MultipleChoiceQuestionTestRepository multipleChoiceQuestionTestRepository, SubCategoryRepository subCategoryRepository) {
